...
const Faq = () => {
    return (
        <div>
            <h2 className="heading-title my-5" id='services'>Frequently Asked Question </h2>
            <div className='bg-secondary w-100 mb-3' style={{ height: '1px' }}></div>
            <Accordion defaultActiveKey="0">
                <Accordion.Item eventKey="0">
                    <Accordion.Header className='text-start '>The Tour Concept of Bangladesh?</Accordion.Header>
